...
def you_tell_me(y_1, y_2, t):
    #use the predictions as soft labels for the other model
    
    #select indices for the first model

    #find indices for the second model

    
# def hybrid_loss(y_1, t_1, y_2, t_2, y_3, t_3):
#     # Model 1 and Model 2 are used in combination to update the parameters of Model 3
