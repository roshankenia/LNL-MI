...
for i in range(5):
    ...
    model_trainer = KModelTrain(x_tensor, y_tensor, k=10)
    ...
    print(
        f'Total Relabeled using BCE, and furthest: {totalRelabel2}, Correctly Relabeled: {correctRelabel2}, Incorrectly Relabeled: {incorrectRelabel2}')
    print(
        f'Total Relabeled using label, BCE, and furthest: {totalRelabel3}, Correctly Relabeled: {correctRelabel3}, Incorrectly Relabeled: {incorrectRelabel3}')
